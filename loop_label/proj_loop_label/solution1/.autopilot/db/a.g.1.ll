; ModuleID = '/home/qingqing/git/hello-world/loop_label/proj_loop_label/solution1/.autopilot/db/a.g.1.bc'
...
for.inc.split:                                    ; preds = %for.inc
  ...
  %shl.ln79 = shl i64 %i, 2, !dbg !34             ; [#uses=1 type=i64] [debug line = 79:12]
  %ashr.ln79 = ashr exact i64 %shl.ln79, 2, !dbg !34 ; [#uses=2 type=i64] [debug line = 79:12]
  %A.addr = getelementptr [50 x i32]* %A, i64 0, i64 %ashr.ln79, !dbg !34 ; [#uses=1 type=i32*] [debug line = 79:12]
  %A.load = load i32* %A.addr, align 4, !dbg !34  ; [#uses=2 type=i32] [debug line = 79:12]
  ...
  %B.addr = getelementptr [50 x i32]* %B, i64 0, i64 %ashr.ln79, !dbg !37 ; [#uses=1 type=i32*] [debug line = 79:10]
