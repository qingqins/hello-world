; ModuleID = '/home/qingqing/git/hello-world/loop_label/proj_loop_label/solution1/.autopilot/db/a.o.2.bc'
...
for.inc:                                          ; preds = %for.inc.split, %entry
  %i = phi i6 [ %add.ln78, %for.inc.split ], [ 0, %entry ] ; [#uses=3 type=i6]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str) nounwind
  %icmp.ln78 = icmp eq i6 %i, -14, !dbg !28       ; [#uses=1 type=i1] [debug line = 78:23]
...
for.inc.split:                                    ; preds = %for.inc
  ...
  call void @llvm.dbg.value(metadata !{i6 %i}, i64 0, metadata !33), !dbg !32 ; [debug line = 76:7] [debug variable = i]
  %zext.ln79 = zext i6 %i to i64, !dbg !34        ; [#uses=2 type=i64] [debug line = 79:12]
  ...
  %add.ln78 = add i6 %i, 1, !dbg !38              ; [#uses=1 type=i6] [debug line = 78:30]
  br label %for.inc
