...
entity example_example_control_s_axi is
generic (
...
end entity example_example_control_s_axi;
...
architecture behave of example_example_control_s_axi is
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_AP_CTRL =>
                        rdata_data <= (7 => int_auto_restart, 4 => int_ap_continue, 3 => int_ap_ready, 2 => int_ap_idle, 1 => int_ap_done, 0 => int_ap_start, others => '0');
                    when ADDR_GIE =>
