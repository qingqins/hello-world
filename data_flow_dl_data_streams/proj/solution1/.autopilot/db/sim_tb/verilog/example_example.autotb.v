...
`define AUTOTB_TVIN_A_V_data_V  "./c.example_example.autotvin_A_V_data_V.dat"
`define AUTOTB_TVIN_A_V_keep_V  "./c.example_example.autotvin_A_V_keep_V.dat"
`define AUTOTB_TVIN_A_V_strb_V  "./c.example_example.autotvin_A_V_strb_V.dat"
`define AUTOTB_TVIN_A_V_user_V  "./c.example_example.autotvin_A_V_user_V.dat"
`define AUTOTB_TVIN_A_V_last_V  "./c.example_example.autotvin_A_V_last_V.dat"
`define AUTOTB_TVIN_A_V_id_V  "./c.example_example.autotvin_A_V_id_V.dat"
`define AUTOTB_TVIN_A_V_dest_V  "./c.example_example.autotvin_A_V_dest_V.dat"
`define AUTOTB_TVIN_B_V_data_V  "./c.example_example.autotvin_B_V_data_V.dat"
`define AUTOTB_TVIN_B_V_keep_V  "./c.example_example.autotvin_B_V_keep_V.dat"
`define AUTOTB_TVIN_B_V_strb_V  "./c.example_example.autotvin_B_V_strb_V.dat"
`define AUTOTB_TVIN_B_V_user_V  "./c.example_example.autotvin_B_V_user_V.dat"
`define AUTOTB_TVIN_B_V_last_V  "./c.example_example.autotvin_B_V_last_V.dat"
`define AUTOTB_TVIN_B_V_id_V  "./c.example_example.autotvin_B_V_id_V.dat"
`define AUTOTB_TVIN_B_V_dest_V  "./c.example_example.autotvin_B_V_dest_V.dat"
`define AUTOTB_TVIN_A_V_data_V_out_wrapc  "./rtl.example_example.autotvin_A_V_data_V.dat"
`define AUTOTB_TVIN_A_V_keep_V_out_wrapc  "./rtl.example_example.autotvin_A_V_keep_V.dat"
`define AUTOTB_TVIN_A_V_strb_V_out_wrapc  "./rtl.example_example.autotvin_A_V_strb_V.dat"
`define AUTOTB_TVIN_A_V_user_V_out_wrapc  "./rtl.example_example.autotvin_A_V_user_V.dat"
`define AUTOTB_TVIN_A_V_last_V_out_wrapc  "./rtl.example_example.autotvin_A_V_last_V.dat"
`define AUTOTB_TVIN_A_V_id_V_out_wrapc  "./rtl.example_example.autotvin_A_V_id_V.dat"
`define AUTOTB_TVIN_A_V_dest_V_out_wrapc  "./rtl.example_example.autotvin_A_V_dest_V.dat"
`define AUTOTB_TVIN_B_V_data_V_out_wrapc  "./rtl.example_example.autotvin_B_V_data_V.dat"
`define AUTOTB_TVIN_B_V_keep_V_out_wrapc  "./rtl.example_example.autotvin_B_V_keep_V.dat"
`define AUTOTB_TVIN_B_V_strb_V_out_wrapc  "./rtl.example_example.autotvin_B_V_strb_V.dat"
`define AUTOTB_TVIN_B_V_user_V_out_wrapc  "./rtl.example_example.autotvin_B_V_user_V.dat"
`define AUTOTB_TVIN_B_V_last_V_out_wrapc  "./rtl.example_example.autotvin_B_V_last_V.dat"
`define AUTOTB_TVIN_B_V_id_V_out_wrapc  "./rtl.example_example.autotvin_B_V_id_V.dat"
`define AUTOTB_TVIN_B_V_dest_V_out_wrapc  "./rtl.example_example.autotvin_B_V_dest_V.dat"
`define AUTOTB_TVOUT_B_V_data_V  "./c.example_example.autotvout_B_V_data_V.dat"
`define AUTOTB_TVOUT_B_V_keep_V  "./c.example_example.autotvout_B_V_keep_V.dat"
`define AUTOTB_TVOUT_B_V_strb_V  "./c.example_example.autotvout_B_V_strb_V.dat"
`define AUTOTB_TVOUT_B_V_user_V  "./c.example_example.autotvout_B_V_user_V.dat"
`define AUTOTB_TVOUT_B_V_last_V  "./c.example_example.autotvout_B_V_last_V.dat"
`define AUTOTB_TVOUT_B_V_id_V  "./c.example_example.autotvout_B_V_id_V.dat"
`define AUTOTB_TVOUT_B_V_dest_V  "./c.example_example.autotvout_B_V_dest_V.dat"
`define AUTOTB_TVOUT_B_V_data_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_data_V.dat"
`define AUTOTB_TVOUT_B_V_keep_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_keep_V.dat"
`define AUTOTB_TVOUT_B_V_strb_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_strb_V.dat"
`define AUTOTB_TVOUT_B_V_user_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_user_V.dat"
`define AUTOTB_TVOUT_B_V_last_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_last_V.dat"
`define AUTOTB_TVOUT_B_V_id_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_id_V.dat"
`define AUTOTB_TVOUT_B_V_dest_V_out_wrapc  "./impl_rtl.example_example.autotvout_B_V_dest_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_data_V.dat with impl_rtl.example_example.autotvout_B_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_keep_V.dat with impl_rtl.example_example.autotvout_B_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_strb_V.dat with impl_rtl.example_example.autotvout_B_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_user_V.dat with impl_rtl.example_example.autotvout_B_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_last_V.dat with impl_rtl.example_example.autotvout_B_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_id_V.dat with impl_rtl.example_example.autotvout_B_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.example_example.autotvout_B_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.example_example.autotvout_B_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.example_example.autotvout_B_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.example_example.autotvout_B_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.example_example.autotvout_B_V_dest_V.dat with impl_rtl.example_example.autotvout_B_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
