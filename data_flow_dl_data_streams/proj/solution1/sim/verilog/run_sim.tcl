...
if {[file isfile example_example.autotvin.dat]} {
	file delete -force example_example.autotvin.dat
}

if {[file isfile example_example.autotvout.dat]} {
	file delete -force example_example.autotvout.dat
}
