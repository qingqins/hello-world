...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /proj/xbuilds/HEAD_daily_latest/installs/lin64/Scout/HEAD/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/xbuilds/HEAD_daily_latest/installs/lin64/Scout/HEAD/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/xbuilds/HEAD_daily_latest/installs/lin64/Scout/HEAD/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /proj/xbuilds/HEAD_daily_latest/installs/lin64/Scout/HEAD/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "example_example.autotvin.dat"
	set constFileTvOut       "example_example.autotvout.dat"
	set constFileHdlTvIn     "example_example.autohdltvin.dat"
	set constFileHdlTvOut    "example_example.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
